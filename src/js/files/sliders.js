...
function initSliders() {
	...
	if (document.querySelector('.body-product__images')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
		let thumbsSwiper = new Swiper('.images-preview__slider', { // Указываем скласс нужного слайдера
			// Подключаем модули слайдера
			// для конкретного случая
